    ...
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-12">Get in touch with our team to learn more about our mentorship programs</p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">contact@mentorlabs.com</p>
                </div>
              </div>
              <div className="flex items-start">
